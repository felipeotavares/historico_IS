                    ...
                    if not linha_estacao.empty:
                        ...
                        if indice_hora:
                            ...
                            if fim_janela - inicio_janela + 1 >= 20:
                                ...
                                # dados_janela['H_nT_fft'] = np.fft.fft(dados_janela['H_nT'])
...
# plot_amplificacao_por_data(nova_lista_dados_agrupados,ano_selecionado)
...
# %%
def plot_magnetic_field(lista_dados_agrupados, target_date, target_stations, estacoes_conjugadas, campos=["H_nT", "D_nT"]):
    ...
    plt.show()
#%%
target_date = event_dates["Data"][57]
...
plot_magnetic_field(nova_lista_dados_agrupados, target_date, target_station,estacoes_conjugadas,campos)
